...
class _SharedAgentChatDetail extends StatelessWidget {
  const _SharedAgentChatDetail({
    required this.agent,
...
class _SharedChatDetailHeader extends ConsumerWidget {
  const _SharedChatDetailHeader({
    required this.agent,
...
class _SharedEveryoneDetail extends StatelessWidget {
  const _SharedEveryoneDetail({this.showBackButton = false, this.onBack});
